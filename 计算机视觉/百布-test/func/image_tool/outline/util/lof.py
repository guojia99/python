"""
    https://github.com/damjankuznar/pylof/blob/master/lof.py
"""
...
class LOF:
    ...
    def compute_instance_attribute_bounds(self):
        ...
        if not all(diff):
            ...
            warnings.warn(
                "No data variation in dimensions: %s. You should check your data or disable normalization." % problematic_dimensions)
